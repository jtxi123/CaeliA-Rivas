...
void displayMeasurement(JsonDocument &telemetry)
{
  ...
  if (displayPresent)
  {
    ...
    if (connStatus.wifi) display.drawBitmap(display.width() - 16, 0, wifi1_icon16x16, 16, 16, 1);
    else display.drawBitmap(display.width() - 16, 0, cancel_icon16x16, 16, 16, 1);
    if (connStatus.mqtt) display.drawBitmap(display.width() - 16, 16, arrow_up_icon16x16, 16, 16, 1);
